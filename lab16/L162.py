...
classify = XGBClassifier(n_estimators=100, max_depth=4, learning_rate=0.1,
                    eval_metric="logloss", random_state=69)
classify.fit(X_train, y_train)
print(f"Classifier Accuracy: {accuracy_score(y_test, classify.predict(X_test)):.7f}")
...
regress = XGBRegressor(n_estimators=100, max_depth=4, learning_rate=0.1,
